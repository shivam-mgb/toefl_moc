// src/components/ProseSummaryInput.tsx
import React, { useState } from 'react';
import { ProseSummaryQuestion } from '../../types/types';

interface ProseSummaryInputProps {
  onChange: (data: Omit<ProseSummaryQuestion, 'type'>) => void;
}

const ProseSummaryInput: React.FC<ProseSummaryInputProps> = ({ onChange }) => {
  const [prompt, setPrompt] = useState<string>('Summarize the passage by selecting the correct statements.');
...
export default ProseSummaryInput;