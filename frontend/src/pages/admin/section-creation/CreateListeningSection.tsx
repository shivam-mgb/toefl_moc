...
const CreateListeningSection: React.FC = () => {
  const navigate = useNavigate();
  const [currentStep, setCurrentStep] = useState(1);
  const steps = ['Audio Setup', 'Questions', 'Review'];
  ...
  return (
    <AdminLayout
      title="Create Listening Section"
      breadcrumbItems={[
        { label: "Admin Dashboard", path: "/admin" },
        { label: "Section Creation", path: "/admin/section-creation" },
        { label: "Create Listening Section", path: "/admin/section-creation/listening" }
      ]}
    >
      <StepIndicator steps={steps} currentStep={currentStep} />
      
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">Listening Section Creation</h2>
...
export default CreateListeningSection;
