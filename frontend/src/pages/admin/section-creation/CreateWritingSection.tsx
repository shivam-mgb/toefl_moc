...
const CreateWritingSection: React.FC = () => {
  const navigate = useNavigate();
  const [currentStep, setCurrentStep] = useState(1);
  const steps = ['Task Details', 'Instructions', 'Review'];
  ...
  return (
    <AdminLayout
      title="Create Writing Section"
      breadcrumbItems={[
        { label: "Admin Dashboard", path: "/admin" },
        { label: "Section Creation", path: "/admin/section-creation" },
        { label: "Create Writing Section", path: "/admin/section-creation/writing" }
      ]}
    >
      <StepIndicator steps={steps} currentStep={currentStep} />
      
      <div className="bg-white shadow rounded-lg p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">Writing Section Creation</h2>
...
export default CreateWritingSection;
